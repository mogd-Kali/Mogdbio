...
ascii_banner = pyfiglet.figlet_format("BananaSNOS")
...
def send_complaint(username, telegram_id, number, email, repeats, complaint_choice, proxies=None):
	...
	if complaint_choice == "1":
		text = f'Добрый день поддержка Telegram! Аккаунт {username}, {telegram_id} Прошу разберитесь с этим. Заранее спасибо!'
